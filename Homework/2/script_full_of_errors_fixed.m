...
disp(pi)
pi = '3.14159';                  % character " did not match ' at the end and cannot be used for string on this matlab version
disp(tan(3.14159));              %pi is now defined as a class character with no number value
c = 4^3^2^3;        
a11 = ((c-78564)/c + 32);        %Lacked variable name and had extra )
year = 2017;
Z=['This year is ', num2str(year)];
disp(Z);                         %It did not diplay the year, it was not consistent in class within the disp funtion.
...
class = 'INF1100, gr 2';         %didn't have matching quotes (same error as line 9)
continue_ = x > 0;
